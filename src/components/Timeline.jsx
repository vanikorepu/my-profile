...
const ITEMS = [
  { title: "Training Lead", org: "Gen AI Global — AI 2027", dates: "2025–Present",
  ...
  { title: "Software Engineer", org: "UMass Libraries — Digital Media Lab", dates: "2024–2025",
      ...
      <ol className="tl-list">
        {ITEMS.map((it, i) => (
          <li key={it.title + it.org} className="tl-item">
            ...
            {/* card — now styled like the Contact submit button */}
            <article className="tl-card outline-card">
